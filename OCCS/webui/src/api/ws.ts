export type StreamMessage =
  ...
  | { type: 'progress'; iter: number; loss: number; running_min: number; x: number[]; best_x?: number[] | null; xi?: number | null; kappa?: number | null; gp_max_std?: number | null; no_improve?: number | null }
