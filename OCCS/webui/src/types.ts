...
export type ProgressEvent = { iter: number; loss: number; running_min: number; xi?: number | null; kappa?: number | null; gp_max_std?: number | null; no_improve?: number | null; x: number[] }
